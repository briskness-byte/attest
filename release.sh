...
if [ "${SKIP_TESTS:-0}" != "1" ]; then
    echo "running tests"
    for t in prompt-window copy-key external-callers permission-keys passphrase nostr-links decisions security-boundary page-answers extension-pages origins protection; do
